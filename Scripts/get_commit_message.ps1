...
$API_BASE_URL = "https://api.llm7.io/v1/chat/completions"
$MODEL = "gpt-4.1-nano-2025-04-14"
$API_KEY = "w1IbBZPpp42idVgBXFcwCFfwPzYvWYYMGtjf+W8UhTtU7d+ZgEClQotHlkSYRRYIWKU/GUfqMk0jRYELYzHx0ni/ah/2u8Av9a3wVGYdA8RoSUcpUy7NfmJE8aJgPzVa"
...
- UNACCEPTABLE: Do not use codeblocks (```) or any other markdown formatting. Output raw text only.
...
"@
    ...
    if (-not $responseJson.choices) {
        throw "Не удалось получить сообщение для коммита. Ответ сервера: $responseBody"
    }
    
    $commitMessage = $responseJson.choices[0].message.content
